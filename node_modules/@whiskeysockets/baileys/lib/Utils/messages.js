...
const extractUrlFromText = (text) => {
    if (typeof text !== 'string') return; // Retorna undefined se text não for uma string
    var _a;
...
const generateLinkPreviewIfRequired = async (text, getUrlInfo, logger) => {
    const url = exports.extractUrlFromText(text); // Chamada atualizada para a função exportada
    if (!!getUrlInfo && url) {
        try {
