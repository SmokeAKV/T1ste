...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId = '', participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata, statusJidList }) => {
  // Se messageId não estiver definido, gere um novo ID de mensagem
  const msgId = messageId || Utils_1.generateMessageIDV2(sock.user?.id || undefined);
