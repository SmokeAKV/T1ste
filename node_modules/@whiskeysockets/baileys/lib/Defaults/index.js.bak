...
//const { Browsers } = require('../Utils/generics.js');
...
const { Browsers } = require('@whiskeysockets/baileys/lib/Utils');
const os_1 = require('os'); // Certifique-se de que os_1 esteja importado corretamente
